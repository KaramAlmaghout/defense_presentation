...
\begin{frame}[t]{DLO simulation model and shape-control results}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.43\textwidth}
      ...
      \scriptsize
      \textbf{Linear springs} resist stretching; \textbf{torsion springs}
      resist bending.
      ...
      \raggedright
      {\color{IUBlue}\textbf{Stretching energy} \(E_l\)}
      \[
      ...
      \[
        \begin{aligned}
          \bm p_{\mathrm{inner}}^{*}
          &=\underset{\bm p_2,\ldots,\bm p_{N-1}}{\arg\min}\ E(\bm p),\\[-0.2ex]
    ...
    \begin{column}{0.55\textwidth}
      ...
      \begin{tabular}{@{}cccc@{}}
        \includegraphics[width=0.128\textwidth,height=1.62cm,keepaspectratio]{c1.png} &
        \includegraphics[width=0.128\textwidth,height=1.62cm,keepaspectratio]{c2.png} &
        \includegraphics[width=0.128\textwidth,height=1.62cm,keepaspectratio]{c3.png} &
        \includegraphics[width=0.128\textwidth,height=1.62cm,keepaspectratio]{c4.png}\\[-0.28ex]
      ...
      \vspace{0.02cm}
      \begin{tabular}{@{}cccc@{}}
        \includegraphics[width=0.128\textwidth,height=1.62cm,keepaspectratio]{f1_07.png} &
        \includegraphics[width=0.128\textwidth,height=1.62cm,keepaspectratio]{f2_07.png} &
        \includegraphics[width=0.128\textwidth,height=1.62cm,keepaspectratio]{f3_07.png} &
        \includegraphics[width=0.128\textwidth,height=1.62cm,keepaspectratio]{f4_07.png}\\[-0.28ex]
        \tiny U: 4.2 mm &
        \tiny L: 6.9 mm &
        \tiny S: 6.5 mm &
        \tiny M: 4.2 mm
